<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Deployment.aspx.vb" Inherits="Deployment" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Materials Approved</title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
        <div style="text-align: center; background-color: blue;">
            <table style="font-size: small; z-index: 100; left: 0px; width: 70%; font-family: Verdana;
                position: static; top: 0px; height: 100%; background-color: white;">
                <tr>
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 41px">
                                    <asp:ImageButton ID="ImageButton2" runat="server" Height="40px" ImageUrl="~/images/homemade.jpg"
                                        PostBackUrl="~/materials.aspx" Style="z-index: 100; left: 152px; position: static;
                                ...
                                <td align="left" style="width: 41px">
                                    <asp:ImageButton ID="ImageButton3" runat="server" Height="40px" ImageUrl="~/images/techbtn.jpg"
                                        ...
                                        top: 40px" ToolTip="Survey Technician" Width="40px" Enabled="False" /></td>
                                <td align="left" style="width: 50px">
                                    <asp:ImageButton ID="ImageButton4" runat="server" Height="40px" ImageUrl="~/images/teambtn.jpg"
                                        ...
                                        top: 40px" ToolTip="Implementation Team" Width="40px" Enabled="False" /></td>
                    ...
                    <td colspan="3">
                        <div style="text-align: center">
                            <table style="z-index: 100;
                                left: 120px; width: 100%;
                                position: static; top: 456px; height: 100%; color: navy; background-color: transparent; font-family: tahoma; font-size: small;">
                                <tr>
                                    <td style="width: 100px">
                                    </td>
                                ...
                                <tr>
                                    <td style="font-weight: bold; font-size: medium; text-transform: capitalize; color: mintcream; font-family: tahoma; background-color: cornflowerblue; height: 22px;" colspan="7">
                                        materials Approved</td>
                                </tr>
                                <tr>
                                    <td style="width: 100px">
                                    </td>
                                    <td align="right" style="width: 174px">
                                        Project Name</td>
                                    <td align="left" style="width: 100px">
                                        <asp:DropDownList ID="DDLproname" runat="server" Style="z-index: 100; left: 296px;
                                            position: static; top: 248px" AutoPostBack="True" Width="24px">
                                            <asp:ListItem></asp:ListItem>
                                        </asp:DropDownList></td>
                                    <td align="left" style="width: 100px">
                                        Address</td>
                                    <td colspan="2" rowspan="3">
                                        <asp:TextBox ID="Txtadd" runat="server" Height="64px" Style="z-index: 100; left: 464px;
                                            position: static; top: 248px" TextMode="MultiLine" Width="248px" AutoPostBack="True"></asp:TextBox></td>
                                    <td style="width: 100px">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="right" style="width: 174px">
                                        Site code</td>
                                    <td align="left" style="width: 100px">
                                        <asp:DropDownList ID="DDLsiteid" runat="server" Style="z-index: 100; left: 272px;
                                            position: static; top: 264px" AutoPostBack="True">
                                            <asp:ListItem></asp:ListItem>
                                        </asp:DropDownList></td>
                                    <td style="width: 100px">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" style="font-size: small; font-family: calibri">
                                        Select the materials available deployment and click "&gt;&gt;". If the &nbsp;material
                                        or quantity is not available &nbsp;enter the materials gray box below in this format
                                        ( Item-Quantity) and ensure to put a comma to separate fields.</td>
                                    <td style="width: 100px">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        Requested Materials</td>
                                    <td style="width: 100px">
                                    </td>
                                    <td colspan="2">
                                        Materials to be deployed</td>
                                    <td style="width: 100px">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left" colspan="2" rowspan="5">
                                        <asp:ListBox ID="Listrequest" runat="server" Height="136px" SelectionMode="Multiple"
                                            Style="z-index: 100; left: 200px; position: static; top: 376px" Width="216px"></asp:ListBox></td>
                                    <td style="width: 100px">
                                    </td>
                                    <td align="left" colspan="2" rowspan="9">
                                        <asp:ListBox ID="Listdeployed" runat="server" Height="320px" Style="z-index: 100;
                                            left: 432px; position: static; top: 416px" Width="264px" AutoPostBack="True" SelectionMode="Multiple"></asp:ListBox></td>
                                    <td style="width: 100px">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px">
                                        <asp:Button ID="Btnpass" runat="server" Style="z-index: 100; left: 392px; position: static;
                                            top: 432px" Text=">>" /></td>
                                    <td style="width: 100px">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="font-size: small; font-family: calibri">
                                        &nbsp;Enter the materials in this format ( Item-Quantity) and ensure to put a comma
                                        to separate fields. and click "+"</td>
                                    <td style="width: 100px">
                                    </td>
                                    <td style="width: 100px">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td align="left" colspan="2">
                                        <asp:TextBox ID="Txtother" runat="server" BackColor="White" ForeColor="Navy" Height="88px"
                                            Style="z-index: 100; left: 176px; position: static; top: 512px" TextMode="MultiLine"
                                            Width="208px"></asp:TextBox></td>
                                    <td style="width: 100px">
                                        <asp:Button ID="Btnadd" runat="server" Style="z-index: 100; left: 392px; position: static;
                                            top: 544px" Text="+" /></td>
                                    <td style="width: 100px">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 174px">
                                        <asp:TextBox ID="Txtitems" runat="server" Style="z-index: 100; left: 104px; position: static;
                                            top: 824px" Visible="False"></asp:TextBox></td>
                                    <td style="width: 100px">
                                    </td>
                                    <td style="width: 100px">
                                    </td>
                                    <td align="left" colspan="2">
                                        <asp:Button ID="Btnremove" runat="server" Style="z-index: 100; left: 456px; position: static;
                                            top: 624px" Text="Remove" BackColor="CornflowerBlue" BorderStyle="None" ForeColor="White" />
                                        <asp:Button ID="Btndeploy" runat="server" Style="z-index: 100; left: 528px; position: static;
                                            top: 624px" Text="Submit" Width="72px" BackColor="CornflowerBlue" BorderStyle="None" ForeColor="White" />
                                        </td>
                                    <td style="width: 100px">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left" style="width: 100px">
                                        <asp:Button ID="Btnreset" runat="server" Style="z-index: 100; left: 456px; position: static;
                                            top: 656px" Text="Reset" BackColor="CornflowerBlue" BorderStyle="None" ForeColor="White" /></td>
                                    <td style="width: 100px">
                                    </td>
                                    <td style="width: 100px">
                                    </td>
