<%@ Page Language="VB" AutoEventWireup="false" CodeFile="suprint.aspx.vb" Inherits="suprint" %>
...
<body>
    ...
    <div>
        <div style="text-align: center">
            <table style="z-index: 100; left: 304px; position: static; top: 40px">
                <tr>
                ...
                <tr>
                    <td colspan="3">
                        <table style="border-right: blue thin solid; border-top: blue thin solid; font-size: small;
                            z-index: 100; left: 240px; border-left: blue thin solid; color: blue; border-bottom: blue thin solid;
                            font-family: tahoma; position: static; top: 40px">
                            <tr>
                                <td style="width: 21px">
                            ...
                            <tr>
                                ...
                                <td align="right" style="width: 100px">
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/supporttech.aspx" Style="z-index: 100;
                                        left: 552px; position: static; top: 64px" Width="40px">Back</asp:HyperLink></td>
                                <td style="width: 100px">
                                </td>
                            </tr>
                            <tr>
