<%@ Page Language="VB" AutoEventWireup="false" CodeFile="set_cost.aspx.vb" Inherits="set_cost" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Set Cost</title>
                    ...
                    <td colspan="3">
                        <div style="text-align: center; background-color: #330099;">
                            <table style="z-index: 100; left: 240px; width: 592px; position: static; top: 536px;
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px; height: 13px">
                                        <asp:DropDownList ID="DDLstate" runat="server" Style="z-index: 100; left: 344px;
                                            position: static; top: 136px" AutoPostBack="True" Width="129px">
                                            <asp:ListItem>FCT(Abuja)</asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px; height: 13px">
                                        <asp:DropDownList ID="ddldepart" runat="server" Style="z-index: 100; left: 320px;
                                            position: static; top: 104px" Width="130px">
                                            <asp:ListItem>FCT(Abuja)</asp:ListItem>
                                            <asp:ListItem>Abia</asp:ListItem>
                                            <asp:ListItem>Adamawa</asp:ListItem>
                                            <asp:ListItem>Akwa Ibom</asp:ListItem>
                                ...
                                <tr>
                                    <td align="center" 
                                        style="color: #C0C0C0; font-size: medium; font-weight: 700; font-family: Tahoma; background-color: #000080;" 
                                        colspan="6">
                                        Regional Rates</td>
                                </tr>
                                <tr>
                        ...
                        <asp:DropDownList ID="DDLregion" runat="server" AutoPostBack="True" Style="z-index: 100;
                            left: 504px; position: static; top: 80px" Width="131px">
                            ...
                            <asp:ListItem>SE</asp:ListItem>
                                    ...
                                    <td align="left" colspan="2">
                                        ...
                                        <asp:Button ID="Btnrgn" runat="server" Height="22px" Text="Submit" 
                                            Width="61px" />
                                        <asp:Button ID="Btnrupd" runat="server" Height="22px" Text="Update" />
                                    </td>
                                    <td style="width: 100px">
                                        &nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 100px; height: 34px;">
                                        <asp:DropDownList ID="DDLtechlevel" runat="server" Style="z-index: 100; left: 328px;
                                            position: static; top: 272px" Width="128px">
