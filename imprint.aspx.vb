...
Partial Class imprint
    ...
    Sub loadsite()
        'and comment is Null "
        Dim cmd As SqlCommand = New SqlCommand(" select sitecode from techjob where jobtype = @jobtype and techid = @techid ", conn)
    ...
    Sub contact()
        ...
        Try
            ...
            While rdr.Read() = True
                ...
                Me.Txtpurpose.Text = "implementation"
